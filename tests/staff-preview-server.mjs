...
const payloads = {
  ...
  "/api/apply/options": { items: [{ application_type: "judge", label: "Reviewer application", description: "Review Geometry Dash levels and recommend rating tiers.", enabled: true, open: true, cooldown: { days: 5, active: false } }, { application_type: "mod", label: "Mod application", description: "Help moderate GD Avenue and support the community.", enabled: true, open: true, cooldown: { days: 5, active: false } }, { application_type: "appeal", label: "Punishment appeal", description: "Ask GD Avenue to review an active server ban and its supporting evidence.", enabled: true, open: true, cooldown: { days: 30, active: false } }], applications_open: true, application_open_by_type: { judge: true, mod: true }, cooldown: { days: 5, active: false }, cooldowns: { judge: { days: 5, active: false }, mod: { days: 5, active: false } }, active_applications: [], active_application: null, guild_member: true },
  ...
  "/api/apply/form/appeal": { application: null, form: { application_type: "appeal", label: "Punishment appeal", description: "Ask GD Avenue to review the evidence and decision behind your current server ban.", estimated_minutes: 12, sections: ["Grounds", "Your account", "Evidence", "Requested outcome", "Confirmation"] }, punishment: { id: 4, type: "ban", active: true, reason: "Repeated harassment after a moderator warning", reason_known: true, reason_source: "discord_ban", reason_conflict: true, issued_ts: now - 86400 * 12, checked_ts: now - 60, lookup_status: "found", lookup_error: null }, eligibility: { eligible: true, reason: "active_ban", cooldown_until_ts: null }, questions: [
