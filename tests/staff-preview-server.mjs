...
const api = {
  version: legacyApi ? 0 : 3,
  features: legacyApi ? [] : ["application_data_reset", "application_interviews", "application_review_embeds", "application_review_threads", "application_cooldown", "multi_type_applications", "hidden_queue_entries", "staff_manual_management", "task_assignment_dm", "view_role_preview"],
};
const queue = [
...
const payloads = {
  ...
  "/api/apply/options": { items: [{ application_type: "judge", label: "Reviewer application", description: "Review Geometry Dash levels and recommend rating tiers.", enabled: true }, { application_type: "mod", label: "Mod application", description: "Help moderate GD Avenue and support the community.", enabled: true }, { application_type: "appeal", label: "Appeal application", description: "This application will be added in a future update.", enabled: false }], applications_open: true, cooldown: { days: 5, active: false, until_ts: null, remaining_seconds: 0 }, active_application: null },
